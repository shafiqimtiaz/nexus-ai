...
| 2.3  | Slack Tool (xoxc user token + d cookie)         | `[x]`  |
| 3.1  | AI Agent Chat (Gemini + tools + MCP)            | `[x]`  |
| 3.2  | Mid-Conversation Model Selector                 | `[x]`  |
| 3.3  | Google Calendar Write + Study Planner           | `[x]`  |
| 4.1  | Dashboard Page                                  | `[x]`  |
| 4.2  | Agent Activity Log (autonomous action audit)    | `[x]`  |
